...
# Afin de ne pas surcharger ses serveurs, OpenAlex limite le nombre de coauteurs
# par articles dans les données renvoyées lorsqu'on effectue une requête sur
# plus d'un article. On procède donc en deux temps : dans un premier temps on
# récupère tous les articles avec plus de 100 coauteurs via une une boucle "for"  
# pour requêter un par un les articles avec plus de 100 auteurs.
...
df_all_parts <- df_all_parts %>% unnest_longer("authorships")
